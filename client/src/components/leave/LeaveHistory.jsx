                      ...
                      leaves.map((leave)=>{
                        return (
                          <tr key={leave._id || leave.id}>
                            ...
                            <td className="max-w-xs truncate text-slate-50" title={leave.reason}>
                              {leave.reason}
                            </td>
                                    ...
                                    {leave.status === "PENDING" && (
                                        <div>
                                            ...
                                            className="p-1.5 rounded-md bg-emerald-50 text-emerald-600 hover:bg-emerald-100 transition-colors">
                                                {
                                                    processing === (leave._id || leave.id) ? <Loader className="w-4 h-4 animate-spin"/>:<Check className="w-4 h-4"/>
                                                }
                                            </button>
                                            ...
                                            className="p-1.5 rounded-md bg-rose-50 text-rose-600 hover:bg-rose-100 transition-colors">
                                                {
                                                    processing === (leave._id || leave.id) ? <Loader className="w-4 h-4 animate-spin"/>:<X className="w-4 h-4"/>
                                                }
                                            </button>
                                        </div>
                                    )}
