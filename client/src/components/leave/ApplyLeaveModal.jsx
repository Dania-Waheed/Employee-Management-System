        ...
        onClick={(e)=>e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="startDate" requied min={minDate} />
                        </div>
                        <div>
                            <span className="block text-xs text-slate-400 mb-1">To</span>
                            <input type="date" name="endDate" requied min={minDate} />
                        </div>
                    </div>
                </div>
                {/* reason */}
                <div>
                    ...
                    <textarea name="reason" requied rows={3} className="resize-none" placeholder="Briefly describe why you need this leave..."/>
                </div>
                {/* buttons */}
